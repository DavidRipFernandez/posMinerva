...
public partial class NsoftContext : DbContext
{
    public NsoftContext()
    {
    }

    public NsoftContext(DbContextOptions<NsoftContext> options)
        : base(options)
    {
    }
...
//    => optionsBuilder.UseSqlServer("Server=(localdb)\\jripalda;Database=Nsoft;TrustServerCertificate=True;");
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240CA89269C4");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843FB6AC7FB0");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF48307BE2F40");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E10722A61FAF");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547E51D4FC74");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A132D1A140BE");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76B28BB4F2");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D8939B810A");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEE008AB58C");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6E4E17258");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D5614FF3FE146");
